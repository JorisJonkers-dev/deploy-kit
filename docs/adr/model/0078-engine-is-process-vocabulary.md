...
fact the Application knows first, and a context republish before a new datastore can
...
| Platform-side mapping keyed by Application Id | Nothing new in layer 1 | Puts a fact the Application knows first into platform data, and a new datastore needs a context republish before it can be backed up |
