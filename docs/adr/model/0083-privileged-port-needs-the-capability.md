...
claim: settled
date: 2026-09-07
normative: spec/v1/10-project-intent.md#a-privileged-port-needs-the-capability-that-binds-it
rests-on: ["0005"]
---
...
## Rests on
Every Process in this estate can listen above 1024, so no rendered pod needs a
...
no Process declaring a port below 1024.
...
Rewriting the port silently (deriving a high `targetPort` while the Application
