...
| [0043](0043-delete-authority-durability-gate.md) | delivery | deletion gated by Durability Class; no automatic PVC deletes | taken up by [0137](../model/0137-the-render-leaves-flaggers-objects-to-flagger.md): a claim whose class derives a backup is never pruned ([chapter 30](../../../spec/v1/30-deliverables.md#flagger-ready-objects)) |
