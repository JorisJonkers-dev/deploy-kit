...
([0053](../model/0053-adapter-port-contract.md)) carries the kind set as contract data (`src/adapters/registry.ts` lacks such a field) and both derive from it. A PVC
