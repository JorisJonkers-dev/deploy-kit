...
It is shown in three figures, cut from its own source by the same script that
cuts the project half. Figure~\ref{fig:platformfacts} holds the facts about the
cluster and what must exist before a rendered object can land,
...
per engine, and the cadences the derivations read.
