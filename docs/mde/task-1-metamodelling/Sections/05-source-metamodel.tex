...
migration builds on, and how a release is switched: which applications perform
...
holds what delivery reads: the migration runner and its terms, and the delivery
machinery with its analysis cadence.
...
\begin{figure}[!htbp]
\centering
\includegraphics[width=0.62\linewidth, keepaspectratio]{Figures/s-plat-d}
