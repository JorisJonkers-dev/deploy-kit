...
what varies: the migration image and the revision it was tested against; the
identity that runs it, the owner role and the deadline are fixed functions of the
...
a rollout strategy or a Canary. It records the hardening posture and the
