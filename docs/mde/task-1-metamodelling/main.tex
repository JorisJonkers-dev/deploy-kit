...
% XML and XMI: tag names in blue, attribute names in violet, values as strings.
\lstdefinelanguage{xmi}[]{XML}{
  tagstyle=\color{codekey}, markfirstintag=true, usekeywordsintag=true,
  keywordstyle=\color{codeattr}, alsoletter={:-},
  morekeywords={apiVersion,kind,schemaVersion,project,owner,id,process,surface,
    path,name,host,audience,contentPolicy,startupBudget,cutover,image,runtime,
    memory,cpu,key,value,port,xsi:type,revision,namespace,alertClass,
    reconcileUnit,deadline,interval,iterations,threshold,tier,match,precedence,
    identity,uid,gid,switchover,replicas,hardening,identityToken,period,
    failures,eligibleNodes}}
\lstdefinelanguage{json}{
  morestring=[b]", sensitive=true, keywords={true,false,null}}
