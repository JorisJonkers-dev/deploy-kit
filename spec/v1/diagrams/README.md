...
| white, dashed border | `#64748b` | outside the model: co-testing, still parked ([`docs/adr/deferred/`](../../../docs/adr/deferred/README.md)). Delivery is inside the model ([chapter 55](../55-delivery.md)) and is drawn in the palette above |
