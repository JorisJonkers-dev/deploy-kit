...
| the alert rule catalog, the class-to-receiver mapping, scrape `interval` and `scrapeTimeout` | [0079](../../../docs/adr/model/0079-alert-class-derives-from-a-rule-catalog.md) | Platform document |
