...
| [`prepare-process-serves.project.yml`](prepare-process-serves.project.yml) | `E_PREPARE_PROCESS_SERVES` | a prepare Process declaring a port, probes and a cutover: it runs to completion and serves nothing ([chapter 10](../../10-project-intent.md#prepare-processes)) |
