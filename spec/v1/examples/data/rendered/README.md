...
| `apps/platform-postgres/servicemonitor.yaml` | `prometheus` | `scrape {port, path}`, `provides` (9187 → `metrics`) | cadence from the Platform document ([G-19](#g-19)); the operator's `release` selector ([G-21](#g-21)); a PrometheusRule from `alertClass: page` ([G-33](#g-33)) |
...
| `apps/platform-rabbitmq/servicemonitor.yaml` | `prometheus` | `scrape`, `provides` (15692 → `metrics`) | cadence from the Platform document; a rule from `alertClass: urgent` ([G-33](#g-33)) |
