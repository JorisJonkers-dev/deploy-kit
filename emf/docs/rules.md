...
| EMF-013 | Every model behaviour has a JUnit witness, in whichever language its module is written, or is listed as pending with the ticket that lands it | `tests/parity/src/test/kotlin/dev/jorisjonkers/deploykit/emf/parity/LedgersTest.kt` | `Ledgers.checkWitnesses(repository)` |
